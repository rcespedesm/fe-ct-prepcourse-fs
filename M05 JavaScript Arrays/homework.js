...
function incrementarPorUno(array) {
   ...
   // Tu código:
   return array.map(elemento => elemento = elemento + 1)
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   total = agregarNumeros(resultadosTest)
...
function numeroMasGrande(arrayOfNums) {
   ...
   for(i = 0; i < arrayOfNums.length ; i++){
      if(arrayOfNums[i] > bigNumber){
         bigNumber = arrayOfNums[i];
      }
   }
   return bigNumber;
}
